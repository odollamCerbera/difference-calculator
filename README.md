...
Проект представляет собой программу для сравнения файлов, которая после установки становится доступной по имени gendiff. Данная утилита принимает два аргумента — абсолютные или относительные пути двух файлов, которые сравниваяются между собой. Поддерживаются форматы входных данных json, yaml (файлы с расширением .yml, .yaml).
...
```
git clone https://github.com/odollamCerbera/difference-calculator.git
make install  
npm link 
```
